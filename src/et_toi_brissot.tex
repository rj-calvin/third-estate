...
\startgensonne
-- My apologies! My apologies, gentlemen!
\stop
...
influence is derived from two observations that are infallibly consistent with
all known records of history.
\stop
...
\startleibniz
First is the observation that the human mind is endowed with an indefinite
perfectibility that is cultivated by the limits of experience and the
...
contingent on the revelation and proliferation of new truths between such
peoples.
\stop
...
essential for forbidding any central authority from establishing a doctrine
that prevents the teaching of truths contrary to superstitious dogma or
momentary agendas.
\stop
...
\startvoltaire
The plan for public education that we present to the assembly has been the
culmination of what several centuries of observation has taught us about the
...
\startvoltaire
And among such observations comes the warning that without education all such
progress will cease.

If we allow ourselves to perpetuate the ignorance of citizens, our revolution
will inevitably enter a state of regression until the day it quietly slips back
into the chains of feudalism.
\stop
...
\startvoltaire
Thus, our objective today is to accelerate its arrival, to build our
institutions that shall foster the enlightenment of our friends and neighbors,
and to remind us to always remain vigilant for the happy day~--
\stop
