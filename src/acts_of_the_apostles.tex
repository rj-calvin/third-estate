...
\startcondorcet
Consider that having rights established in writing provides us with two
important utilities:
...
\startcondorcet
-- Ah, perhaps if we consider the application of \leibniz's principles of
...
% TODO: introduce the characteristica universalis.
...
\(beat)
At the \jacobins this morning, \robespierre presented an argument that's been
turning in my head all day.
\stop
...
\startcondorcet
What? A peaceful petition would provide such an opportunity?
\stop
