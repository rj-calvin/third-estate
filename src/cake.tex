...
\startsophie
Oh. Yes. That is worth considering.
\stop
...
\stage \cabanis begins serving the cake.
...
\startcondorcet
They fear progress because they're ashamed of having not contributed to it!
\stop
...
\startsophie
-- Oh, no. It was nothing. Never mind it.
\stop

\stage \condorcet nods and smiles as he plans out the story.

\startcondorcet
Ah! Alright!

So, suppose it is after dinner at the Tuileries, and Marie Antoinette decides
to request cake for dessert.
...
\startcondorcet
Then the dilemma disappears - but only in appearance!

Because what you are describing, \paine[thomas], is a pairwise majority
decision function, and all pairwise majority decision functions are vulnerable
to strategy.
\stop
...
\startcondorcet
Ah, I'm afraid that you must bear with me on some of my nomenclature.

You are doubtless familiar with pairwise majority decision functions.

These functions are constructed of two alternatives where the outcome is
...
\startcondorcet
If... No. It is {\emph imperative} that we discover a {\emph non}-trivial,
strategy-proof decision function!
\stop
...
\startsophie
Why must you ALWAYS -- don't touch me!
\stop
...
\stage \condorcet and \brissot, for some reason, expects \paine to speak.
