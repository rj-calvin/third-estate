...
But without education, all such progress will cease, and our revolution will
fail to achieve its singular, most essential function: the incremental
improvement of our laws.

It is our hope that these plans may nurture the seeds that will hasten the
moment when all errors will be eliminated and when prejudices will lose all
...
\stage \condorcet dismounts the tribune.

\startgensonne
Next on the list, \vergniaud is to receive the floor.
\stop

\stage \vergniaud[theeagle] delivers his speech pacing the floor.

\startvergniaud
GENTLEMEN!

To what degree is a nation obligated to defend those who have abandoned it?

If it is true that it is a natural right for a man to leave his country for his
displeasure of it, by what reciprocal role shall his country have in the social
contract thus violated?
\stop

\stage Pause. The \assembly quiets down.

\startvergniaud
The social contract is inked by the duty distilled from mutual obligation.

Thus, when the fatherland pleas for aid, what citizen has the right to abandon
it?

Any citizen who does so extinguishes the flame that rewards the faithful with
the guilt-free enjoyment of their rights.

\beat

But suppose, for a moment, that emigrants do not flee out of mere unhappiness
for their homeland, but are instead banished from its midst by their own hatred
and fury.

Suppose that these men proceed to form a belt of conspiracy at its borders,
incite its soldiers to desertion, fan flames to ignite doubts in our children,
and finally, with torch and iron in hand, cry criminal vows to the indignant
heavens to coat their former home in ash and ruin!
\stop

\stage The \assembly exchanges nervous glances.

\startvergniaud
What obligations remain for such a land scorned by this manner of evil?

Is it not forced to consider such men its enemies?
\stop
...
Oh, where were you in the Roman senate when Cicero denounced the conspiracy of
Catiline?

Would you have asked for proof then?

Would you have felt satisfied to watch Rome burn as Cicero desperately
scrounged for letters and documents?

Would you have dreamt of dancing with Catiline on the rubble of Rome's
destruction?

\beat

In combat, threats are responded to with instinct, not contemplation and rigor.

To demand proof at such a critical moment is to sabotage our ability to act - a
call for delay is a call for suicide.

Thus, gentlemen, you have just heard the voice of a counter-revolutionary!
\stop

\stage The \assembly is bewildered: what a scandal!

\startvergniaud
Men who remain loyal to our blessed nation do so because they have sworn their
fealty to the constitution that shall grant them their happiness.

But we must not be believe that the hatred which threatens our revolution
ceases to exist for the convenience of our preparedness.

Hatred will act so long as it has hope, thus it is our duty to extinguish it.
...
\startvergniaud
Citizens, free men, DEFEND YOUR FREEDOM!

Ensure the hope of the human race, or you will not merit its pity in your
misfortunes!
\stop

\stage A second round of applause.

\startvergniaud
Monsieur \president! I motion that \louis be petitioned to declare war on these
emigrants, these princes, these traitors and counter-revolutionaries!
\stop

\stage \gensonne stands.

\stage Pause.

\startgensonne
I carry the motion to a vote by nominal call. Shall \louis be petitioned to
declare war on Austria?
\stop

\stage The \assembly cheers. Poor \condorcet is absolutely bewildered.

\startgensonne
Antonelle.
\stop

\startanonymous[cue={Antonelle}]
Oui.
\stop
...
Non. France would be foolish to attack unprovoked and unprepared!
\stop

\stage The \brissotins groan.
...
\stage \condorcet stands with a stunned look on his face.

\stage Pause.

\stage Pause. Whispers.

\stage \condorcet is motionless.
...
\stage Pause. Confused glances are exchanged.
