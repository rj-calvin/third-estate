...
\startvoltaire
Like the kind that burn heretics on a stake? Or the kind that don't exist?
\stop
...
\startcondorcet
But... what should be done to convince the public of the virtues of a republic?
...
Or if they all give each other funny titles to let everyone know they don't pay
taxes.
\stop
...
\startcondorcet
Ah. So it seems that majority decisions are vulnerable to strategy.

What would be an example of a strategy-proof decision function, professor?
\stop
...
But that would be a \underbar{trivial} decision function.

We are only interested in \underbar{non-trivial} decision functions.
\stop
