...
prevent the rise of an emperor?
...
\startvoltaire
The first for the clergy, the nobles get the second, but what's the third for?
\stop
...
\startvoltaire
Such as if, for example, they're all wearing funny robes and worshipping some
ancient dogma or tradition.

Or if they all give each other funny titles to signal that they are exempt from
paying taxes.
\stop

\startleibniz
Consider, why would the third estate submit their preferences honestly when
they know that this will end up favoring the second estate?
...
\startcondorcet
What would be an example of a decision function that is strategy-proof,
professor?
\stop
...
We are only interested in non-trivial functions.
\stop
